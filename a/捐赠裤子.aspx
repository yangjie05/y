<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="捐赠裤子.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <head>
        ...
        <label> 我要捐赠</label><br />
&nbsp;<label><font size="3" color="red">注：捐赠的裤子要五成新，不破烂，已清洗消毒 </font></label>
		<meta charset="UTF-8">
		<title></title>

<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="我要兑换.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <a href="Default.aspx"><input type="button" id="btn_login" value="返回" onclick="login();"/></a><label>我要兑换</label>
		<ul class="mainmenu">
        <li><a href="兑换/捐赠衣服.aspx"><b><img src="images/tb01.png"/></b><span>衣服</span></a></li>
        <li><a href="兑换/捐赠裤子.aspx" ><b><img src="images/tb02.png" /></b><span>裤子</span></a></li>
        <li><a href="兑换/捐赠鞋子.aspx" ><b><img src="images/tb03.png" /></b><span>鞋子</span></a></li>
        <li><a href="兑换/捐赠书籍.aspx" ><b><img src="images/tb04.png" /></b><span>书籍</span></a></li>
        <li><a href="兑换/捐赠文具.aspx" ><b><img src="images/tb05.png" /></b><span>文具</span></a></li>
        <li><a href="兑换/捐赠乐器.aspx" ><b><img src="images/tb06.png" /></b><span>乐器</span></a></li>
        <li><a href="兑换/捐赠体育器材.aspx" ><b><img src="images/tb07.png" /></b><span>体育器材</span></a></li>
        <li><a href="兑换/捐赠电子产品.aspx" ><b><img src="images/tb08.png" /></b><span>电子产品</span></a></li>
        <li><a href="兑换/捐赠其他.aspx" ><b><img src="images/tb09.png" /></b><span>其他</span></a></li>          
    </ul>
